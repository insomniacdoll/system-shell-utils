...
c.JupyterHub.pid_file = '/etc/jupyterhub/jupyterhub-proxy.pid'
...
c.JupyterHub.port = 28888
c.Spawner.ip = '127.0.0.1'
c.PAMAuthenticator.encoding = 'utf8'
c.JupyterHub.statsd_prefix = 'jupyterhub'
c.Spawner.notebook_dir = '/home/hiyoru/workspaces/jupyter_projects' #jupyterhub自定义目录
c.JupyterHub.statsd_prefix = 'jupyterhub'
